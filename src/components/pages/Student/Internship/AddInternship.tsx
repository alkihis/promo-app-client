...
import CompanyModal, { CompanyResume } from '../../Modals/CompanyModal';
import { Marger, errorToText, studentDashboardLink } from '../../../../utils/helpers';
import ContactModal, { ContactResume } from '../../Modals/ContactModal';
import { toast } from '../../../shared/Toaster/Toaster';
import APIHELPER from '../../../../utils/APIHelper';
import StudentContext from '../../../shared/StudentContext/StudentContext';
import { Link, Redirect } from 'react-router-dom';

export default class AddInternship extends React.Component {
  render() {
    return (
